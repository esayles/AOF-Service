    ...
    def get(self, request):
        return JsonResponse({
            'endpoints': {
                ...
                '/api/admin/students/{user_id}/profile/': ['GET (admin only)'],
...
urlpatterns += [
    ...
    path('api/admin/students/<int:user_id>/profile/', AdminStudentProfileView.as_view()),
    path('api/admin/preferences/', AdminPreferencesView.as_view()),
    path('api/admin/activities/', AdminActivitiesView.as_view()),
